...
const messageStart = document.querySelector(".message-container p:nth-child(3)");
...
Game.prototype.getStatus = function() {
    if (this.state === Game.prototype.initialState) return "idle";
...
Game.prototype.moveUtil = function() {
    ...
    this.fillCells();
    score.innerHTML = this.score;
    if (this.getStatus() === "win") messageWin.className = "message message-win";
    if (this.getStatus() === "lose") messageLose.className = "message message-lose";
};
startButton.addEventListener("click", ()=>{
    if (startButton.className === "button start") game.start();
    if (startButton.className === "button restart") game.restart();
});
